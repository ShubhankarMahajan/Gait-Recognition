...
label.pack()
button = ttk.Button(root,text="Convolutional Neural Network (CNN)",width=50,command=cnn)
button.pack()
button = ttk.Button(root,text="Support Vector Machine (SVM)",width=50,command=svm)
button.pack()
button = ttk.Button(root,text="Random Forest (RF)",width=50,command=rf)
button.pack()
button = ttk.Button(root,text="Multilayer perceptron (MLP)",width=50,command=mlp)
button.pack()
